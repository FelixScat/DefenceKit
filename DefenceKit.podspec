...
Pod::Spec.new do |s|
  s.name             = 'DefenceKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DefenceKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Felix/DefenceKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Felix' => 'Felix@gmail.com' }
  s.source           = { :git => 'https://github.com/Felix/DefenceKit.git', :tag => s.version.to_s }
